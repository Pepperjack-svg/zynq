...
services:
  ...
  zynqcloud:
    ...
    environment:
      NODE_ENV: production
      PORT: 4000
      # NOTE: If DATABASE_PASSWORD contains URL-reserved characters (@ : / %)
      # the connection string below may break. Use alphanumeric passwords or
      # URL-encode any special characters before setting DATABASE_PASSWORD.
